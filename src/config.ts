...
export const themeConfig: ThemeConfig = {
  ...
  site: {
    ...
    title: 'L1thosphere',
    // site subtitle
    subtitle: 'A romantic, love Renaissance',
    // site description
    description: 'L1thosphere is a personal blog built with Astro, Vite, and TypeScript. It is a place where I share my thoughts, experiences, and knowledge on various topics.',
  ...
  footer: {
    ...
    links: [
      {
        name: 'GitHub',
        url: 'https://github.com/L1thosphere',
      },
      {
        name: 'Email',
        url: 'zhouty20@gmail.com',
      },
      // {
      //   name: 'X',
